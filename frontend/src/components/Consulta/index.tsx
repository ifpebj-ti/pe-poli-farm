...
export default function TelaConsulta() {
  ...
  return (
    <Box sx={{ p: 4, bgcolor: '#fff', minHeight: '100vh' }}>
      ...
      <Grid container spacing={2} mb={3}>
        <Grid size={4}>
          <Typography sx={{ color: 'grey.700' }}>Bulhas Cardíacas:</Typography>
          <Select
            fullWidth
        ...
        <Grid size={4}>
          ...
          >
            ...
            <MenuItem value="Presente, Arrítmico">Presente, Arrítmico</MenuItem>
        ...
        <Grid size={4}>
          ...
          >
            ...
            <MenuItem value="Taquicardia Sinusal">Taquicardia Sinusal</MenuItem>
            <MenuItem value="Bradicardia Sinusal">Bradicardia Sinusal</MenuItem>
      ...
      {/* Cardio - Este título está incorreto, provavelmente deveria ser "Neurológico" ou "Exame Neurológico" */}
      <Typography variant="h6" color="black" sx={{ mb: 2 }}>
        Exame Neurológico
      </Typography>{' '}
      ...
      >
        ...
        <Grid size={6} sx={{ mr: 12 }}>
          {' '}
          {/* Increased margin-right significantly */}
