  ...
  return (
    ...
    >
          ...
          endAdornment: (
            <InputAdornment position="end">
              <IconButton onClick={() => setShowPassword((prev) => !prev)}>
                {showPassword ? <VisibilityOff sx={{ color: '#1351B4' }}/> : <Visibility sx={{ color: '#1351B4' }}/>}
              </IconButton>
            </InputAdornment>
          ),
        }}
      ...
      <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2, gap: 3 }}>
        ...
        sx={{borderRadius: '20px',textTransform: 'none',px: 3,borderColor: '#1351B4', color: '#1351B4'}}>Voltar</Button>
        <Button variant="contained"
        sx={{borderRadius: '20px',textTransform: 'none',px: 3, backgroundColor: '#1351B4',}}>Alterar</Button>
      </Box>
    </Box>
  );
}
