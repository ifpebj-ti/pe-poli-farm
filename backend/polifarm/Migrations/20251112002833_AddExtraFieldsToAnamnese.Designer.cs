...
namespace WebApi.Migrations
{
    ...
    [Migration("20251112002833_AddExtraFieldsToAnamnese")]
    partial class AddExtraFieldsToAnamnese
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Anamnese.AnamneseEntity", b =>
                {
                    ...
                    b.Property<string>("CardiacBubbles")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("MotorResponse")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PulmonaryAuscultation")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("RespiratoryPattern")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.OwnsOne("Domain.ValuesObjects.ExamPriorityStatus", "Priority", b1 =>
                        {
                            ...
                            b1.HasKey("PatientExamsEntityId");

                            b1.ToTable("PatientExamsEntity");

                            b1.WithOwner()
                                .HasForeignKey("PatientExamsEntityId");
                        });
